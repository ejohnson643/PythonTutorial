.. A Python Tutorial for Data Scientists documentation master file, created by
   sphinx-quickstart on Thu Sep  3 14:48:55 2020.
...
| Created by `Eric Johnson <ericjohnson1.2015@u.northwestern.edu>`_.
...
The tutorial will be conducted via `Jupyter Notebooks <https://jupyter.org>`_, which provide a free and easy-to-use platform for Python programming.
...
.. toctree::
   ...
   1_Introduction/helloworld
   2_Variables_DataTypes/vars_types
   3_Lists_Arrays/lists_arrays
   4_Loops/loops
   5_ConditionalStatements/ifelse
   6_Functions/functions
   7_Plotting/plotting
   8_Loading_Writing/readwrite
   9_Dictionaries/dicts
   10_RandomNumbers/random
   11_Classes/classes
